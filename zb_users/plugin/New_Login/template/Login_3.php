...
<link rel='stylesheet' href='{$host}zb_users/plugin/New_Login/static/css/bootstrap.min.css'>
<!---图标库--->
<link rel='stylesheet' href='https://unicons.iconscout.com/release/v2.1.9/css/unicons.css'>
<link rel="stylesheet" href="{$host}zb_users/plugin/New_Login/static/css/login_3.css">
<style>
	#verfiycode {
    cursor: pointer;
    position: absolute;
									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group">
												<input type="text" class="form-style"  id="edtUserName" name="edtUserName" placeholder="{$lang['msg']['username']}" autocomplete="off">
												<i class="input-icon uil uil-user"></i>
											</div>	
											<div class="form-group mt-2">
												<input type="password" class="form-style" id="edtPassWord" name="edtPassWord" placeholder="{$lang['msg']['password']}" autocomplete="off">
											...
											{/if}
											<p class="form-check mb-0 mt-4 text-justify"><input type="checkbox" name="chkRemember" id="chkRemember"><label for="chkRemember">{$lang['msg']['stay_signed_in']}</label></p>
			                                <input type="hidden" name="username" id="username" value="" />
                                            <input type="hidden" name="password" id="password" value="" />
                                            <input type="hidden" name="savedate" id="savedate" value="1" />
											<input class="btn mt-4" id="btnPost" type="submit" name="btnPost" value="{$lang['msg']['login']}">
			      				        </form>
				      					</div>
			      					</div>
			      				</div>
