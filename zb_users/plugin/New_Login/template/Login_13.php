...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="{$host}zb_users/plugin/New_Login/static/css/default.css" rel="stylesheet" type="text/css" />
		<!--必要样式-->
        <link rel="stylesheet" href="{$host}zb_users/plugin/New_Login/static/css/login_13.css">
		<link href="{$host}zb_users/plugin/New_Login/static/css/loaders.css" rel="stylesheet" type="text/css" />
	</head>
	...
	<body>
		<div class='login'>
			...
			<div class='login_fields'>
				...
				<div class='login_fields__user'>
					<div class='icon'>
						<img alt="" src='{$host}zb_users/plugin/New_Login/static/img/user_icon_copy.png'>
					</div>
					<input id="edtUserName" name="edtUserName" placeholder="{$lang['msg']['username']}" maxlength="16" type='text' autocomplete="off" />
					<div class='validation'>
						<img alt="" src='{$host}zb_users/plugin/New_Login/static/img/tick.png'>
					</div>
				</div>
				<div class='login_fields__password'>
					<div class='icon'>
						<img alt="" src='{$host}zb_users/plugin/New_Login/static/img/lock_icon_copy.png'>
					</div>
					<input id="edtPassWord" name="edtPassWord" placeholder="{$lang['msg']['password']}" maxlength="16" type='password' autocomplete="off">
					<div class='validation'>
						<img alt="" src='{$host}zb_users/plugin/New_Login/static/img/tick.png'>
					</div>
				</div>
				...
				<div class='login_fields__password'>
					<div class='icon'>
						<img alt="" src='{$host}zb_users/plugin/New_Login/static/img/key.png'>
					</div>
				...
				<div class='login_fields__submit'>
					<input type="submit" id="btnPost"  value="{$lang['msg']['login']}">
				</div>
				</form>
			</div>
			<div class='success'>
		...
		<link href="{$host}zb_users/plugin/New_Login/static/layui/css/layui.css" rel="stylesheet" type="text/css" />
		
		<script type="text/javascript" src="{$host}zb_users/plugin/New_Login/static/js/jquery-ui.min.js"></script>
		<script type="text/javascript" src='{$host}zb_users/plugin/New_Login/static/js/stopExecutionOnTimeout.js?t=1'></script>
		<script type="text/javascript" src="{$host}zb_users/plugin/New_Login/static/layui/layui.js"></script>
		<script type="text/javascript" src="{$host}zb_users/plugin/New_Login/static/js/Particleground.js"></script>
		<script type="text/javascript" src="{$host}zb_users/plugin/New_Login/static/Js/Treatment.js"></script>
		<script type="text/javascript" src="{$host}zb_users/plugin/New_Login/static/js/jquery.mockjax.js"></script>
		...
		<script type="text/javascript" src="{$host}zb_users/plugin/New_Login/static/img/ThreeWebGL.js"></script>
		<script type="text/javascript" src="{$host}zb_users/plugin/New_Login/static/img/ThreeExtras.js"></script>
		<script type="text/javascript" src="{$host}zb_users/plugin/New_Login/static/img/Detector.js"></script>
		<script type="text/javascript" src="{$host}zb_users/plugin/New_Login/static/img/RequestAnimationFrame.js"></script>
