		...
		var e = {
				...
				"./src/containers.ts": (e, t, r) => {
					...
					t.rootContainer = new n.Lazy((function() {
						...
						return e.id = "party-js-container", o(e, {
							position: "absolute",
							left: "0",
							top: "0",
							pointerEvents: "none",
						...
						}), document.body.appendChild(e), window.requestAnimationFrame((function t() {
							s(e) && (e.style.height = document.body.offsetHeight + "px", e.style.width = document.body.offsetWidth + "px"), window.requestAnimationFrame(t)
						})), e
					}), s), t.debugContainer = new n.Lazy((function() {
						var e = document.createElement("div");
						return e.id = "party-js-debug", o(e, {
							position: "absolute",
							top: "0",
							left: "0",
							margin: "0.5em",
						...
						}), t.rootContainer.current.appendChild(e), e
					}), s), t.particleContainer = new n.Lazy((function() {
						var e = document.createElement("div");
						return e.id = "party-js-particles", o(e, {
							width: "100%",
							height: "100%",
							overflow: "hidden",
							perspective: "100vw"
					...
					var n = r("./src/containers.ts"),
						...
						s = function() {
							...
							return e.prototype.tick = function(e) {
								...
								t.style.display !== r && (t.style.display = r), o.settings.debug && (this.refreshTimer += e, this.refreshTimer > 1 / this.refreshRate && (this.refreshTimer = 0, t.innerHTML = this.getDebugInformation(e)
									.join("<br>")))
				...
				"./src/index.ts": function(e, t, r) {
					...
					var n = r("./src/components/index.ts"),
						o = r("./src/particles/emitter.ts"),
						s = r("./src/particles/particle.ts"),
						a = r("./src/scene.ts"),
						c = r("./src/settings.ts"),
						u = r("./src/systems/math.ts"),
						l = r("./src/systems/modules.ts"),
						d = r("./src/systems/random.ts"),
						p = r("./src/systems/shapes.ts"),
						f = r("./src/systems/sources.ts"),
						h = r("./src/systems/variation.ts"),
						m = r("./src/templates/index.ts"),
						v = r("./src/util/index.ts"),
						y = new v.Lazy((function() {
					...
					var i = r("./src/components/vector.ts"),
						...
						u = function() {
							...
							return Object.defineProperty(e.prototype, "isExpired", {
								...
								return this.particles.splice(0)
									.length
								...
								var e = new c.Particle({
									...
									velocity: i.Vector.from2dAngle(o.evaluateVariation(this.emission.angle))
				...
				"./src/particles/options/renderOptions.ts": (e, t) => {
					...
					function o(e, t) {
						t.style.transform = "translateX(" + e.location.x.toFixed(3) + "px) translateY(" + e.location.y.toFixed(3) + "px) translateZ(" + e.location.z.toFixed(3) + "px) rotateX(" + e.rotation.x.toFixed(3) + "deg) rotateY(" + e.rotation.y.toFixed(3) + "deg) rotateZ(" + e.rotation.z.toFixed(3) + "deg) scale(" + e.size.toFixed(3) + ")"
					}
					Object.defineProperty(t, "__esModule", {
						value: !0
				...
				"./src/particles/renderer.ts": (e, t, r) => {
					...
					var i = r("./src/components/vector.ts"),
						n = r("./src/containers.ts"),
						o = r("./src/systems/shapes.ts"),
						s = r("./src/util/index.ts"),
						a = function() {
							function e() {
								this.elements = new Map, this.light = new i.Vector(0, 0, 1)
							}
							return e.prototype.begin = function() {
								...
								for (var e = this.elements.keys(), t = e.next(); !t.done;) {
									var r = t.value;
									this.renderedParticles.includes(r) || (this.elements.get(r)
										.remove(), this.elements.delete(r)), t = e.next()
								}
								...
								if (r.applyColor && r.applyColor(e.color, i), r.applyOpacity && r.applyOpacity(e.opacity, i), r.applyLighting) {
									var n = s.rotationToNormal(e.rotation)
										.dot(this.light);
									r.applyLighting(n, i)
								}
								r.applyTransform && r.applyTransform(e, i), this.renderedParticles.push(e.id)
							}, e.prototype.createParticleElement = function(e, t) {
								var r = o.resolveShapeFactory(t.shapeFactory)
									.cloneNode(!0);
								return r.style.position = "absolute", this.elements.set(e.id, n.particleContainer.current.appendChild(r)), r
							}, e
						}();
					t.Renderer = a
				},
							...
							return e.prototype.createEmitter = function(e) {
								...
								try {
									for (var r = 0; r < this.emitters.length; r++) {
										(o = this.emitters[r])
										.tick(t), o.isExpired && o.canRemove && this.emitters.splice(r--, 1)
									}
								} catch (e) {
				...
				"./src/templates/confetti.ts": (e, t, r) => {
					...
					t.confetti = function(e, t) {
						var r = i.default.util.overrideDefaults({
							count: i.default.variation.range(20, 40),
							spread: i.default.variation.range(35, 45),
							speed: i.default.variation.range(300, 600),
							size: i.default.variation.skew(1, .2),
							rotation: function() {
							...
							modules: [(new o.ModuleBuilder)
								.drive("size")
								.by((function(e) {
									return Math.min(1, 3 * e)
								}))
								.build(), (new o.ModuleBuilder)
								.drive("rotation")
								.by((function(e) {
									return new n.Vector(140, 200, 260)
										.scale(e)
								}))
								.relative()
								.build()
                        ...
                        console.log(r);
						return i.default.scene.current.createEmitter({
							emitterOptions: {
								loops: 1,
								duration: 8,
								modules: r.modules
					...
					t.sparkles = function(e, t) {
						var r = i.default.util.overrideDefaults({
							...
							modules: [(new o.ModuleBuilder)
								.drive("rotation")
								.by((function(e) {
									return new n.Vector(0, 0, 200)
										.scale(e)
								}))
								.build(), (new o.ModuleBuilder)
								.drive("size")
								.by(new n.NumericSpline({
									time: 0,
									value: 0
								}, {
									time: .3,
