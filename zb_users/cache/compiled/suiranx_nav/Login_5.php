...
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/login_5.css">
</head>
...
<div class="container">
  <div class="left">
    ...
    <form action="#" method="post" id="form1">
    	<?php  echo $csrfToken;  ?>
    <div class="form">
      <input type="text" id="edtUserName" name="edtUserName" placeholder="<?php  echo $lang['msg']['username'];  ?>" class="form-field animation a3">
      <input type="password" id="edtPassWord" name="edtPassWord" placeholder="<?php  echo $lang['msg']['password'];  ?>" class="form-field animation a4">
      <p class="animation a5"><input type="checkbox" name="chkRemember" id="chkRemember"  tabindex="98" /><label for="chkRemember"><?php  echo $lang['msg']['stay_signed_in'];  ?></label></p>
