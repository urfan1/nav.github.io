...
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/login_0.css">
<style>
#verfiycode {
    margin-right: -200px;
    margin-top: -66px;
...
<div class="container right-panel-active">
	...
	<div class="container__form container--signin">
		<form method="post" action="#" class="form" id="form1">
			...
			<?php  echo $G2Fa;  ?>
			<div><input type="checkbox" name="chkRemember" id="chkRemember"  tabindex="98" /><label for="chkRemember"><?php  echo $lang['msg']['stay_signed_in'];  ?></label></div>
...
<!--<script  src="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/js/login_0.js"></script>-->
</body>
</html>
