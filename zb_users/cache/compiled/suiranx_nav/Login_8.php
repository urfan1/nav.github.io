...
<link rel="stylesheet" type="text/css" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/login_8.css" />
<link rel="stylesheet" type="text/css" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/normalize.css" />
<link rel="stylesheet" type="text/css" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/demo.css" />
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/js/vendor/jgrowl/css/jquery.jgrowl.min.css">
<!--[if IE]>
...
<body>
					...
					<div class="logo_box">
						...
						<form action="#" method="post" id="form1">
							...
							<div class="input_outer">
								...
								<input id="edtUserName" name="edtUserName" placeholder="<?php  echo $lang['msg']['username'];  ?>" class="text" style="color: #000000 !important" type="text">
							</div>
							<div class="input_outer">
								<span class="us_uer"></span>
								<input id="edtPassWord" name="edtPassWord" placeholder="<?php  echo $lang['msg']['password'];  ?>" class="text" style="color: #000000 !important; position:absolute; z-index:100;" type="password">
							</div>
    						 <?php if ($G2Fa !=='') { ?>  	
							<div class="input_outer">
								<span class="us_uer"></span>
							...
							<div id="LOGIN" class="mb2"><button class="act-but submit" id="btnPost" type="submit" style="color: #FFFFFF"><?php  echo $lang['msg']['login'];  ?></button></div>
						</form>
					</div>
				</div>
			</div>
		...
		<script src="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/js/vendor/jgrowl/jquery.jgrowl.min.js"></script>
