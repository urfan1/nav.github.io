...
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/login_16.css">
    ...
    <div class="dwo">
        ...
        <form method="post" action="#" class="form" id="form1">
            ...
            <div class="form-group">
                ...
                <p class="checkbox"><input type="checkbox" name="chkRemember" id="chkRemember" tabindex="98"><label for="chkRemember"><?php  echo $lang['msg']['stay_signed_in'];  ?></label></p>
