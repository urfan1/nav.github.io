...
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/normalize.css">
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/login_9.css">
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/sign-up-login.css">
<link rel="stylesheet" type="text/css" href="//cdn.bootcss.com/font-awesome/4.6.0/css/font-awesome.min.css">
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/inputEffect.css" />
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/tooltips.css" />
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/spop.min.css" />

<script src="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/js/snow.js"></script>
<script src="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/js/jquery.pure.tooltips.js"></script>
<script src="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/js/spop.min.js"></script>
...
body{
	...
	background-image: url(<?php  echo $host;  ?>zb_users/plugin/New_Login/static/img/snow.jpg);
			...
			<div class="login sign-in-htm">
				<form class="container offset1 loginform" method="post" action="#" id="form1">
					...
					<div class="pad input-container">
						<section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" autocomplete="off" id="edtUserName" name="edtUserName" placeholder="<?php  echo $lang['msg']['username'];  ?>" tabindex="1" maxlength="15" />
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" id="edtPassWord" name="edtPassWord" placeholder="<?php  echo $lang['msg']['password'];  ?>" tabindex="2" maxlength="15"/>
					...
					<div class="form-actions">
						<div class="btn pull-left btn-link text-muted"><input type="checkbox" name="chkRemember" id="chkRemember" class="pull-left" tabindex="98"><label for="chkRemember" class="pull-left text-muted"><?php  echo $lang['msg']['stay_signed_in'];  ?></label></div>
						<a tabindex="5" class="btn btn-link text-muted" onClick="goto_register()">注册</a>
						<input class="btn btn-primary" id="btnPost" name="btnPost" type="submit" value="<?php  echo $lang['msg']['login'];  ?>" 
							style="color:white;"/>
					</div>
				</form>
			</div>
