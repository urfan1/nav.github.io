...
<link rel="stylesheet" href="<?php  echo $host;  ?>zb_users/plugin/New_Login/static/css/login_4.css">
<style>
...
<form method="post" action="#" class="form" id="form1">
   ...
   <div class="input-content">
     ...
     <p class="p user_icon">
       <input type="text" id="edtUserName" name="edtUserName" placeholder="<?php  echo $lang['msg']['username'];  ?>" autocomplete="off" class="login_txtbx">
     </p> 
     <p class="p pwd_icon">
       <input type="password" id="edtPassWord" name="edtPassWord" placeholder="<?php  echo $lang['msg']['password'];  ?>" autocomplete="off" class="login_txtbx">
     </p>   
     <?php if ($G2Fa !=='') { ?>  	
     <p class="p val_icon">
      ...
      <div class="signup">
      	  <button class="gv" id="btnPost" type="submit"><?php  echo $lang['msg']['login'];  ?></button>
     </div>
  </div>
  </form>
