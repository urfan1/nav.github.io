...
/** 微信公众号信息配置 */
$WXconfig=array(
	'app_id' => 'wx4c6604d40c7998c5', //公众号appId
	'app_secret' => '2e3736d1d7d9a93f2d5849ebb6da0ffb', //公众号appSecret
	'template_id' => 'DgO37QBGgIUmtZEXrKW3zOPqhXB5Z7ypHRVRtDxD2kA', //模板消息id
	'user' => array('o_JcL694RHAZvkzcV46aFOjidjc0') //接收公众号消息的微信号，如果有多个，需要在()里用英文逗号间隔，例如('君临','小君')
);
